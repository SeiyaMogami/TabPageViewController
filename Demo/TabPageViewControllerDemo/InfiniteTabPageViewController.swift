...
class InfiniteTabPageViewController: TabPageViewController {
    ...
    override init() {
        ...
        tabItems = [
            TabItem(title: "Mon.", viewController: vc1), TabItem(title: "Tue.", viewController: vc2), TabItem(title: "Wed.", viewController: vc3),
            TabItem(title: "Thu.", viewController: vc4), TabItem(title: "Fri.", viewController: vc5)
        ]
        // isInfinity = true
