...
class InfiniteTabPageViewController: TabPageViewController {
    ...
    override init() {
        ...
        tabItems = [(vc1, "Mon.", TabType.viewController), (vc2, "Tue.", TabType.viewController), (vc3, "Wed.", TabType.viewController), (vc4, "Thu.", TabType.viewController), (vc5, "Fri.", TabType.viewController)]
        // isInfinity = true
