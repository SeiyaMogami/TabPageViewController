...
internal class TabView: UIView {
    ...
    var pageTabItems: [(title: String, displayable: Bool)] = [] {
        didSet {
...
extension TabView: UICollectionViewDataSource {
    ...
    fileprivate func configureCell(_ cell: TabCollectionCell, indexPath: IndexPath) {
        ...
        cell.item = pageTabItems[fixedIndex].title
        cell.displayable = pageTabItems[fixedIndex].displayable
        cell.option = option
        cell.isCurrent = fixedIndex == (currentIndex % pageTabItemsCount)
        cell.tabItemButtonPressedBlock = { [weak self, weak cell] in
            guard cell?.displayable == true else {
                self?.pageItemPressedBlock?(fixedIndex, UIPageViewControllerNavigationDirection.forward)
                return
            }
